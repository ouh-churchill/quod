"""
Django settings for quodsite project.
...
ROOT_DIR = environ.Path(__file__) - 3  # quod-repo/config/settings/common.py - 3 = {{ quod-repo }}/)
APPS_DIR = ROOT_DIR.path('quodsite')
