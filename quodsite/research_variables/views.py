...
from django.views.generic import ListView, TemplateView, DetailView, FormView, ListView
from .models import NewSession
from .models import NewVariable
from .models import NewCategory
from .models import NewSection
from .models import SaveSession
from .models import SaveSession2
...
class ViewAllForm(DetailView):
    #template_name = 'research_variables/view_all_form.html'
    model = SaveSession2
